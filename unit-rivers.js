  ...
  cards: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'read', title: 'Mesopotamia: the land between the rivers', source: 'Britannica Kids', url: 'https://kids.britannica.com/kids/article/ancient-Mesopotamia/353499', body: '<p>Read about Sumer, then hold these in your head:</p><ul><li>Cities like Uruk ran as <b>city-states</b> — each city was its own little country with its own ruler and god.</li><li>They dug <b>irrigation</b> canals to spread river water to fields farther from the banks — engineering their way to more surplus.</li><li>They invented the wheel, the plow, written law, and the 60-minute hour (that is why an hour still has 60 minutes).</li></ul>' },
        { type: 'read', title: 'Primary source: the Code of Hammurabi', source: 'read', body: '<p>Around 1750 BCE, King Hammurabi carved 282 laws into a stone pillar — one of the first times a society wrote its rules down for everyone. A famous one:</p><blockquote>"If a builder builds a house and the house collapses and kills the owner, the builder shall be put to death."</blockquote><p>Rough — but notice what it means: the rules are public, written, and the same for a whole society. That is government you can point to.</p>' },
        { type: 'quiz', questions: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'read', title: 'Gather your facts', source: 'Britannica Kids', url: 'https://kids.britannica.com/kids/browse/history', body: '<p>Research your civilization and collect notes on these five things. Jot them below as you go.</p>' },
        { type: 'answers', prompts: [
