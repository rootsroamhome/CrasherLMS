...
window.HS_UNITS.push({
  ...
  cards: [
    ...
    {
      id: 'cycle-a', n: 2, title: 'The Water Cycle: How Water Moves', subject: 'Science', minutes: 30, standards: '7.ESS2.1',
      blocks: [
        ...
        { type: 'learn', title: 'Learn the water cycle — your way', note: 'Watch it or read it, whichever works for you today. (Both are here.)', options: [
          { kind: 'video', label: 'Watch it', title: 'NASA — Earth\'s Water Cycle', yt: 'c_M9qp3lwcU', focus: 'One thing to figure out: where does the water go, and what is pushing it?' },
          { kind: 'read', label: 'Read it', title: 'The Water Cycle', source: 'reading', url: 'reader.html?doc=water-cycle', body: '<p>The short of it — the whole cycle is really just <b>two forces trading off</b>:</p><ul><li>The <b>sun</b> adds energy and lifts water up as vapor — <b>evaporation</b> from oceans and lakes, and <em>transpiration</em> breathed out by plants.</li><li>Up high it cools, and <b>condensation</b> turns that vapor into cloud droplets.</li><li><b>Gravity</b> takes over and pulls it back down as <b>precipitation</b> — rain, snow, hail.</li><li>It collects: some soaks in as <b>groundwater</b>, some runs downhill to rivers and back to the sea. Then the loop starts over.</li></ul>' },
        ] },
    ...
    {
      id: 'cycle-b', n: 3, title: 'The Water Cycle: Make It Rain', subject: 'Science', minutes: 30, standards: '7.ESS2.1',
      blocks: [
    ...
    {
      id: 'land-a', n: 4, title: 'Water Shapes Land: Erosion & Deposition', subject: 'Science', minutes: 30, standards: '7.ESS2.2 · 7.ESS2.1',
      blocks: [
    ...
    {
      id: 'land-b', n: 5, title: 'Water Shapes Land: Build a River', subject: 'Science', minutes: 35, standards: '7.ESS2.2',
      blocks: [
    ...
    {
      id: 'cities-a', n: 6, title: 'Floodplains to Cities: The Chain Reaction', subject: 'Humanities · Science', minutes: 35, standards: '7.G.HI.4 · 7.H.CH.3 · 7.LS2.1',
      blocks: [
    ...
    {
      id: 'cities-b', n: 7, title: 'Floodplains to Cities: Map the Chain', subject: 'Humanities', minutes: 30, standards: '7.G.HI.4',
      blocks: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'read', title: 'Mesopotamia: the land between the rivers', source: 'reading', url: 'reader.html?doc=mesopotamia', body: '<p>Hold these in your head:</p><ul><li>Cities like Uruk ran as <b>city-states</b> — each city was its own little country with its own ruler and god.</li><li>They dug <b>irrigation</b> canals to spread river water to fields farther from the banks — engineering their way to more surplus.</li><li>They invented the wheel, the plow, written law, and the 60-minute hour (that is why an hour still has 60 minutes).</li></ul>' },
    ...
    {
      id: 'portrait-a', n: 9, title: 'Portrait of a Civilization: Gather Your Facts', subject: 'Humanities · ELA', minutes: 35, standards: '7.H.CH.3 · 7.W.2',
      blocks: [
    ...
    {
      id: 'portrait-b', n: 10, title: 'Portrait of a Civilization: Build It', subject: 'Humanities · ELA', minutes: 45, standards: '7.W.2 · 7.SL.4',
      blocks: [
    ...
    /* ───────────────── PHASE 3 · POWER & HOME ───────────────── */
    {
      id: 'myths-a', n: 11, title: 'Flood Myths: Gilgamesh & Yu the Great', subject: 'ELA', minutes: 35, standards: '7.RL.2 · 7.RL.9',
      blocks: [
    ...
    {
      id: 'myths-b', n: 12, title: 'Flood Myths: Tell Your Own', subject: 'ELA', minutes: 35, standards: '7.W.3 · 7.RL.9',
      blocks: [
        { type: 'choice', title: 'Show what you know — your pick', note: 'Two rivers, two flood stories. Make something of your own — pick your lane.', options: [
          { kind: 'write', label: 'Write a myth', input: 'text', prompt: 'Write your own river myth — a short story that explains a flood, a drought, or why a river bends where it does. Give it characters and a lesson.' },
          { kind: 'write', label: 'Compare the two', input: 'text', prompt: 'Write a paragraph comparing Gilgamesh\'s flood and Yu the Great: how are they alike and different, and what does each say about its people?' },
          { kind: 'record', label: 'Record it', input: 'link', prompt: 'Record yourself telling your own river myth aloud like a storyteller, OR giving a 60-second compare-and-contrast of the two floods. Paste the link.' },
        ] },
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'choice', title: 'Show what you know — your pick', note: 'Bring the unit home to your own river. Pick how to show it.', options: [
          { kind: 'write', label: 'Write it', input: 'text', prompt: 'How is the Rogue like the Nile in this unit, and how is it different? The Rogue\'s dams were removed and salmon returned — does that change your argument about damming rivers? Why or why not?' },
          { kind: 'record', label: 'Record it', input: 'link', prompt: 'Record a 60-second "our river" segment: how the Rogue mirrors the Nile\'s story, and your take on the dam-removal trade-off. Paste the link.' },
          { kind: 'draw', label: 'Map it', input: 'link', prompt: 'Draw a before/after of a Rogue dam — what it gave (power, irrigation) and what it cost (salmon, silt) — and take a side. Snap a photo and paste the link.' },
        ] },
    ...
    {
      id: 'reflect-b', n: 16, title: 'Reflection: Your Answer', subject: 'Portfolio', minutes: 40, standards: '7.W.2 · synthesis',
      blocks: [
